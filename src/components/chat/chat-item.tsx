...
export const ChatItem = ({
  ...
  const canDeleteMessage = getDeletePermission();
  ...
  function getDeletePermission() {
    if (type === "channel") {
      // For channels: owner, admin, or moderator can delete
      return !isDeleted && (isOwner || isAdmin || isModerator);
    } else {
      // For conversations: only message owner can delete
      return !isDeleted && isOwner;
    }
  }
  return (
